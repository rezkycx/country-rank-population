...
const Home = () => {
  ...
  const [countryLimitPage] = useState(25)
    ...
    <div className="flex justify-center min-h-screen bg-gray-200">
      <div className="container mx-auto overflow-x-auto">
        ...
        <div className="hidden md:block overflow-x-auto">
          <table className="min-w-full table-auto border-collapse bg-gray-300 shadow-lg">
            <thead>
            ...
            <tbody>
              {currentCountry.map((country) => (
                <tr
                  key={country.cca3}
                  className="text-center hover:bg-gray-500 transition duration-300"
                >
        ...
        <div className="block md:hidden">
          {currentCountry.map((country) => (
            <div
              key={country.cca3}
              className="border border-gray-300 mb-4 p-4 rounded-md bg-slate-300 shadow-md"
            >
